...
public static class InitializerScopeTests
{
    public static void Run(string work)
    {
        ...
        File.WriteAllText(a, "using N = One.Numbers; public partial class SplitInit { public int A = N.Value; }");
        File.WriteAllText(b, "using N = Two.Numbers; public partial class SplitInit { public int B = N.Value; public int Sum() => A + B; }");
