...
public sealed record FieldSym(FieldSymbol Field) : Sym;
public sealed record ThisSym(Type Type) : Sym;
...
public sealed record TypeNameSym(TypeSymbol Symbol) : Sym;
...
public sealed record PropertySetSym(MethodSymbol Setter) : Sym;

/// <summary>Everything binding learned, consulted by code generation.</summary>
